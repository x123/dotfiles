{
  ...
  systemd.network = {
    ...
    networks."99-ethernet" = {
      ...
      routes = [
        {
          Destination = "185.156.175.172/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.173/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.174/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.36/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.37/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.38/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.44/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.45/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.46/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.52/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.53/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.54/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.59/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.61/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "185.156.175.62/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "195.206.105.228/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "195.206.105.229/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "195.206.105.230/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "86.106.84.147/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "86.106.84.148/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "86.106.84.149/32";
          Gateway = "192.168.1.1";
        }
        {
          Destination = "86.106.84.163/32";
          Gateway = "192.168.1.1";
        }
        {
