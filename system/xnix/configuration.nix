  ...
  users.users = {
    builder = {
      ...
      openssh.authorizedKeys.keys = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIRUp2hF+EOoXTVPDxsWyW/5xJecWmljel5ZNbaCQCv6 root@forge"
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIGrZ+hx0suGxQXk8MmVGpjIPPBOOHVHFIBTUCuBuXhD root@kumanix"
      ];
    };
    x = {
      isNormalUser = true;
